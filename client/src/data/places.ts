...
export const bakery: Place[] = [
  {
    ...
    photos: [
      { url: '', alt: 'Empório do Pão - fachada', isPlaceholder: true },
      { url: '', alt: 'Empório do Pão - pães e salgados', isPlaceholder: true },
      { url: '', alt: 'Empório do Pão - vitrine', isPlaceholder: true },
    ],
...
export const feira: Place[] = [
  {
    ...
    photos: [
      { url: '', alt: 'Delícias da Roça - barraca', isPlaceholder: true },
      { url: '', alt: 'Delícias da Roça - doces de cupuaçu', isPlaceholder: true },
      { url: '', alt: 'Delícias da Roça - banana frita', isPlaceholder: true },
    ],
  ...
  },
  {
    ...
    photos: [
      { url: '', alt: 'Barraquinha de Frutas - tucumã', isPlaceholder: true },
      { url: '', alt: 'Barraquinha de Frutas - produtos', isPlaceholder: true },
    ],
  ...
  },
  {
    ...
    photos: [
      { url: '', alt: 'Frutas e Mel Mandacaru - barraca', isPlaceholder: true },
      { url: '', alt: 'Mel Mandacaru - produto', isPlaceholder: true },
    ],
  ...
  },
  {
    ...
    photos: [
      { url: '', alt: 'Castanha descascada na hora - barraca', isPlaceholder: true },
      { url: '', alt: 'Castanha do Pará - produto', isPlaceholder: true },
    ],
  ...
  },
  {
    ...
    photos: [
      { url: '', alt: 'Pastelaria Paulista - harumaki', isPlaceholder: true },
      { url: '', alt: 'Pastelaria Paulista - pastéis', isPlaceholder: true },
      { url: '', alt: 'Pastelaria Paulista - salgados', isPlaceholder: true },
    ],
